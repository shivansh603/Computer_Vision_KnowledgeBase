...
class YOLOv8Inference:
    """
    A class to test YOLOv8-large models on single images.

    Attributes:
    - model: YOLOv8-large model instance.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, required=True, default= "yolov8l-seg.pt", help="Path to the YOLOv8 model file")
    parser.add_argument("--image_path", type=str, required=True, help="Path to the image to be tested")
    args = parser.parse_args()

    # Create YOLOv8Tester object
    tester = YOLOv8Inference(args.model_path)

    # Test image using YOLOv8Tester
    tester.infer_image(args.image_path)
