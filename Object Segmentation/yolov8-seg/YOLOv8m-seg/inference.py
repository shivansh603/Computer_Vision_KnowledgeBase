...
class YOLOv8Inference:
    """
    A class to test YOLOv8-medium models on single images.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, required=True, default= "yolov8m-seg.pt", help="Path to the YOLOv8 model file")
